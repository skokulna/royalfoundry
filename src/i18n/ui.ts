  ...
  en: {
    ...
    gallery: {
      ...
      captions: {
        ...
        '08-compressed-type-t-clamp': 'Compressed Type T-Clamp',
        '13-transformer-bushing-clamp-for-double-conductor': 'Transformer Bushing Clamp for Double Conductor',
        '16-ct-clamp': 'CT Clamp',
        '35-ab-switch-male-female-new-type': 'A/B Switch Male-Female New type',
        '37-female-contact-assembly': 'Female Contact Assembly',
        '38-female-contact-assembly-sideview': 'Female Contact Assembly SideView',
        '33-ab-switch-11kv-400a': 'A/B Switch 11kV 400A',
        '34-ab-switch-11kv-400a-topview': 'A/B Switch 11kV 400A TopView',
        '44-base-frame-for-section-fuse-with-neutral-link': 'Base Frame for Section Fuse with Neutral link',
        '21-down-lead-clamp': 'Down-lead clamp',
        '29-shorting-clip-with-spike-earth-rod': 'Shorting clip with spike earth rod',
        ...
        '32-earth-rod-with-earthing-clamp': 'Earth rod with earthing clamp',
        '09-crimping-type-double-t-clamp-topview': 'Crimping Type Double T-Clamp TopView',
        '10-crimping-type-double-t-clamp-sideview': 'Crimping Type Double T-Clamp SideView',
        '14-terminal-connector-for-double-conductor': 'Terminal Connector for Double Conductor',
        '17-bent-jumper-connector': 'Bent Jumper Connector',
        '18-jumper-cone': 'Jumper Cone',
        '19-cable-supporting-clamp': 'Cable Supporting Clamp',
        '20-supporting-clamp-type-2': 'Supporting Clamp Type 2',
        '23-quad-spacer': 'Quad Spacer',
        '26-l-clamp': 'L-Clamp',
        '30-shorting-clip-set-with-earthing-rods': 'Shorting clip set with earthing rods',
        '31-single-shorting-clip': 'Single Shorting Clip',
        '45-base-frame-with-neutral-link': 'Base Frame with Neutral Link',
        ...
        '06-t-clamp-for-various-conductors-topview':         'T-clamp for various conductors TopView',
        '07-t-clamp-for-various-conductors-sideview':  'T-clamp for various conductors SideView',
        '11-high-voltage-transformer-bushing-clamp-sideview':    'High Voltage Transformer Bushing clamp SideView',
        '12-high-voltage-transformer-bushing-clamp-topview': 'High Voltage Transformer Bushing clamp TopView',
        '28-tall-clamp-with-bore':    'Tall clamp with bore',
        '25-flat-plate-clamps':  'Flat plate clamps',
        '27-isolator-pad-clamp': 'Isolator (PAD) Clamp',
        '22-bar-spacer-clamp':   'Bar / spacer clamp',
        '04-twin-bore-pg-clamp': 'Twin-bore PG clamp',
        '15-cable-lugs-size-up-to-500sqmm-and-terminal-ends':         'Cable lugs size up to 500sqmm and terminal ends',
        '05-wedge-piece-with-pg-clamp':    'Wedge piece with PG clamp',
        '36-ab-switch-contact-assemblies':    'A/B switch contact assemblies',
        '39-ab-switch-jaw-contacts':  'A/B switch jaw contacts',
        '40-ab-switch-assembled':'A/B switch assembled',
        '41-ab-switch-operating-mechanism-set':   'A/B switch operating mechanism set',
        '42-covered-conductor-clamp-and-hardware-fittings':        'Covered Conductor Clamp and Hardware Fittings',
        '24-nylon-spacer-block': 'Nylon spacer block',
        '43-base-frame-pole-top-with-nylon-sheet':'Base frame (pole top) with nylon sheet',
        '46-tie-bar-connecting-link':            'Tie bar / connecting link',
      },
    },
    products: {
      ...
      items: [
        ...
        },
        {
          slug: 'dtr-boxes',
          name: 'DTR boxes',
          summary: 'Stainless steel distribution transformer boxes insulated inside with FRP sheet, fabricated to your drawing.',
          bullets: ['Distribution transformer (DTR) boxes', 'Insulated inside with FRP sheet', 'Stainless steel sheet metal fabrication', 'Louvred ventilation panels', 'Busbar supports and cable gland plates', 'Made to your drawing or sample'],
        },
        {
          slug: 'fabrication',
  ...
  ml: {
    ...
    gallery: {
      ...
      captions: {
        ...
        '08-compressed-type-t-clamp': 'കംപ്രസ്ഡ് ടൈപ്പ് ടി-ക്ലാമ്പ്',
        '13-transformer-bushing-clamp-for-double-conductor': 'ഡബിൾ കണ്ടക്ടറിനുള്ള ട്രാൻസ്ഫോർമർ ബുഷിംഗ് ക്ലാമ്പ്',
        '16-ct-clamp': 'സി.ടി ക്ലാമ്പ്',
        '35-ab-switch-male-female-new-type': 'എ/ബി സ്വിച്ച് മെയിൽ-ഫീമെയിൽ പുതിയ തരം',
        '37-female-contact-assembly': 'ഫീമെയിൽ കോൺടാക്ട് അസംബ്ലി',
        '38-female-contact-assembly-sideview': 'ഫീമെയിൽ കോൺടാക്ട് അസംബ്ലി — സൈഡ് വ്യൂ',
        '33-ab-switch-11kv-400a': 'എ/ബി സ്വിച്ച് 11 കെ.വി 400 എ',
        '34-ab-switch-11kv-400a-topview': 'എ/ബി സ്വിച്ച് 11 കെ.വി 400 എ — ടോപ്പ് വ്യൂ',
        '44-base-frame-for-section-fuse-with-neutral-link': 'ന്യൂട്രൽ ലിങ്കോടു കൂടിയ സെക്ഷൻ ഫ്യൂസിനുള്ള ബേസ് ഫ്രെയിം',
        '21-down-lead-clamp': 'ഡൗൺലീഡ് ക്ലാമ്പ്',
        '29-shorting-clip-with-spike-earth-rod': 'സ്പൈക്ക് എർത്ത് റോഡോടു കൂടിയ ഷോർട്ടിംഗ് ക്ലിപ്പ്',
        ...
        '32-earth-rod-with-earthing-clamp': 'എർത്തിംഗ് ക്ലാമ്പോടു കൂടിയ എർത്ത് റോഡ്',
        '09-crimping-type-double-t-clamp-topview': 'ക്രിമ്പിംഗ് ടൈപ്പ് ഡബിൾ ടി-ക്ലാമ്പ് — ടോപ്പ് വ്യൂ',
        '10-crimping-type-double-t-clamp-sideview': 'ക്രിമ്പിംഗ് ടൈപ്പ് ഡബിൾ ടി-ക്ലാമ്പ് — സൈഡ് വ്യൂ',
        '14-terminal-connector-for-double-conductor': 'ഡബിൾ കണ്ടക്ടറിനുള്ള ടെർമിനൽ കണക്ടർ',
        '17-bent-jumper-connector': 'ബെന്റ് ജമ്പർ കണക്ടർ',
        '18-jumper-cone': 'ജമ്പർ കോൺ',
        '19-cable-supporting-clamp': 'കേബിൾ സപ്പോർട്ടിംഗ് ക്ലാമ്പ്',
        '20-supporting-clamp-type-2': 'സപ്പോർട്ടിംഗ് ക്ലാമ്പ് ടൈപ്പ് 2',
        '23-quad-spacer': 'ക്വാഡ് സ്പേസർ',
        '26-l-clamp': 'എൽ-ക്ലാമ്പ്',
        '30-shorting-clip-set-with-earthing-rods': 'എർത്തിംഗ് റോഡുകളോടു കൂടിയ ഷോർട്ടിംഗ് ക്ലിപ്പ് സെറ്റ്',
        '31-single-shorting-clip': 'സിംഗിൾ ഷോർട്ടിംഗ് ക്ലിപ്പ്',
        '45-base-frame-with-neutral-link': 'ന്യൂട്രൽ ലിങ്കോടു കൂടിയ ബേസ് ഫ്രെയിം',
        ...
        '06-t-clamp-for-various-conductors-topview':         'വിവിധ കണ്ടക്ടറുകൾക്കുള്ള ടി-ക്ലാമ്പ് — ടോപ്പ് വ്യൂ',
        '07-t-clamp-for-various-conductors-sideview':  'വിവിധ കണ്ടക്ടറുകൾക്കുള്ള ടി-ക്ലാമ്പ് — സൈഡ് വ്യൂ',
        '11-high-voltage-transformer-bushing-clamp-sideview':    'ഹൈ വോൾട്ടേജ് ട്രാൻസ്ഫോർമർ ബുഷിംഗ് ക്ലാമ്പ് — സൈഡ് വ്യൂ',
        '12-high-voltage-transformer-bushing-clamp-topview': 'ഹൈ വോൾട്ടേജ് ട്രാൻസ്ഫോർമർ ബുഷിംഗ് ക്ലാമ്പ് — ടോപ്പ് വ്യൂ',
        '28-tall-clamp-with-bore':    'ബോറോടു കൂടിയ നീളൻ ക്ലാമ്പ്',
        '25-flat-plate-clamps':  'ഫ്ലാറ്റ് പ്ലേറ്റ് ക്ലാമ്പുകൾ',
        '27-isolator-pad-clamp': 'ഐസൊലേറ്റർ (പാഡ്) ക്ലാമ്പ്',
        '22-bar-spacer-clamp':   'ബാർ / സ്പേസർ ക്ലാമ്പ്',
        '04-twin-bore-pg-clamp': 'ഇരട്ട ബോർ പി.ജി ക്ലാമ്പ്',
        '15-cable-lugs-size-up-to-500sqmm-and-terminal-ends':         '500 ചതുരശ്ര മി.മീ വരെയുള്ള കേബിൾ ലഗ്ഗുകളും ടെർമിനൽ എൻഡുകളും',
        '05-wedge-piece-with-pg-clamp':    'പി.ജി ക്ലാമ്പോടു കൂടിയ വെഡ്ജ് പീസ്',
        '36-ab-switch-contact-assemblies':    'എ/ബി സ്വിച്ച് കോൺടാക്ട് അസംബ്ലികൾ',
        '39-ab-switch-jaw-contacts':  'എ/ബി സ്വിച്ച് ജോ കോൺടാക്ടുകൾ',
        '40-ab-switch-assembled':'അസംബിൾ ചെയ്ത എ/ബി സ്വിച്ച്',
        '41-ab-switch-operating-mechanism-set':   'എ/ബി സ്വിച്ച് ഓപ്പറേറ്റിംഗ് മെക്കാനിസം സെറ്റ്',
        '42-covered-conductor-clamp-and-hardware-fittings':        'കവേഡ് കണ്ടക്ടർ ക്ലാമ്പും ഹാർഡ്‌വെയർ ഫിറ്റിംഗുകളും',
        '24-nylon-spacer-block': 'നൈലോൺ സ്പേസർ ബ്ലോക്ക്',
        '43-base-frame-pole-top-with-nylon-sheet':'നൈലോൺ ഷീറ്റോടു കൂടിയ ബേസ് ഫ്രെയിം (പോൾ ടോപ്പ്)',
        '46-tie-bar-connecting-link':            'ടൈ ബാർ / കണക്ടിംഗ് ലിങ്ക്',
      },
    },
    products: {
      ...
      items: [
        ...
        },
        {
          ...
          summary: 'ഉള്ളിൽ എഫ്.ആർ.പി ഷീറ്റ് കൊണ്ട് ഇൻസുലേറ്റ് ചെയ്ത, നിങ്ങളുടെ ഡ്രോയിംഗ് അനുസരിച്ച് നിർമ്മിക്കുന്ന സ്റ്റെയിൻലെസ് സ്റ്റീൽ ഡിസ്ട്രിബ്യൂഷൻ ട്രാൻസ്ഫോർമർ ബോക്സുകൾ.',
          bullets: ['ഡിസ്ട്രിബ്യൂഷൻ ട്രാൻസ്ഫോർമർ (ഡി.ടി.ആർ) ബോക്സുകൾ', 'ഉള്ളിൽ എഫ്.ആർ.പി ഷീറ്റ് ഇൻസുലേഷൻ', 'സ്റ്റെയിൻലെസ് സ്റ്റീൽ ഷീറ്റ് മെറ്റൽ ഫാബ്രിക്കേഷൻ', 'ലൂവർ വെന്റിലേഷൻ പാനലുകൾ', 'ബസ്ബാർ സപ്പോർട്ടുകളും കേബിൾ ഗ്ലാൻഡ് പ്ലേറ്റുകളും', 'ഡ്രോയിംഗ് അല്ലെങ്കിൽ സാമ്പിൾ അനുസരിച്ച്'],
        },
        {
          slug: 'fabrication',
